      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
        ...
        <form action={handleSubmit} className="space-y-4">
          <div className="relative">
            ...
            <Input name="fullName" type="text" placeholder="Full name" required className="pl-10 rounded-xl" />
          </div>
          <div className="relative">
          ...
          {role === 'seller' && (
            <div className="relative">
              ...
              <Input name="companyName" type="text" placeholder="Company name" required className="pl-10 rounded-xl" />
            </div>
          )}

          <div className="flex items-start gap-2">
            <input type="checkbox" required className="w-4 h-4 mt-0.5 rounded text-accent-red border-gray-300" />
            <span className="text-xs text-gray-500">
              I agree to the <a href="#" className="text-accent-red hover:underline">Terms of Service</a> and <a href="#" className="text-accent-red hover:underline">Privacy Policy</a>
            </span>
          </div>

          <Button type="submit" disabled={loading} className="w-full bg-accent-red hover:bg-accent-red-dark text-white rounded-xl" size="lg">
        ...
        <p className="mt-6 text-center text-sm text-gray-500">
          ...
          <Link href="/login" className="text-accent-red font-medium hover:underline">Sign in</Link>
        </p>
      </div>
    </div>
  )
